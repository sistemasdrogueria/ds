...
<div id="foot" ></div>
<div id="mydivbuscar"class="articulos index large-10 medium-9 columns">
...
<?= $this->Form->create('Carritos',['url'=>['controller'=>'Carritos','action'=>'#'],'id'=>'formaddcart','onsubmit'=>'return false;']); ?>
		...
		$cantidadencarrito ="";
			...
			{
				echo $this->Form->input($encabezado.'cantidad',['maxlength'=>"3", 'id'=>'tab'.$indice,'data-cantidad-car'=>$cantidadencarrito, 'data-id-input'=>'tab'.$indice,'tabindex'=>$indice,'data-id'=> $articulo['id'],'data-pv-id'=>  $articulo['descuentos'][1]['id'],'value'=>$cantidadencarrito,'class'=>'formcartcant', 'onkeypress'=>'return soloNumeros(event)','_class'=>'formcartcant','target'=>'_blank'  , 'autocomplete'=>'off']);

			}
			else
			{

				echo $this->Form->input($encabezado.'cantidad',['maxlength'=>"3", 'id'=>'tab'.$indice,'data-cantidad-car'=>$cantidadencarrito, 'data-id-input'=>'tab'.$indice,'tabindex'=>$indice,'value'=>$cantidadencarrito, 'data-id'=> $articulo['id'],'data-pv-id'=> 0,'class'=>'formcartcant','_class'=>'formcartcant', 'onkeypress'=>'return soloNumeros(event)','target'=>'_blank'  , 'autocomplete'=>'off']);

			}
			}
			else
			{
				echo $this->Form->input($encabezado.'cantidad',['maxlength'=>"3", 'id'=>'tab'.$indice,'data-cantidad-car'=>$cantidadencarrito, 'data-id-input'=>'tab'.$indice,'tabindex'=>$indice,'data-id'=> $articulo['id'],'data-pv-id'=> 0,'value'=>$cantidadencarrito,'class'=>'formcartcant','_class'=>'formcartcant', 'onkeypress'=>'return soloNumeros(event)','target'=>'_blank'  , 'autocomplete'=>'off']);
