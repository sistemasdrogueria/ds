...
<?php //$this->Form->create('Carritos',['url'=>['controller'=>'Carritos','action'=>'carritoaddall'],'id'=>'formaddcart','onsubmit'=>'return validaragregar()']); ?>
...
if ($articulo['carritos'] != null) {
	...
	echo $this->Form->input($encabezado . 'cantidad', ['tabindex' => $indice, 'value' => $cantidadencarrito, 'class' => 'formcartcant', 'id' => 'tab' . $indice, 'data-cantidad-car' => $cantidadencarrito, 'data-id-input' => 'tab' . $indice, 'data-id' =>	$articulo['id'], 'data-pv-id' => $descuento_id, 'target' => '_blank', 'onkeypress' => 'return soloNumeros(event)', 'autocomplete' => 'off', 'style' => 'padding: 1px 1px; width:35px;']);
} else {
	echo $this->Form->input($encabezado . 'cantidad', ['tabindex' => $indice, 'class' => 'formcartcant', 'id' => 'tab' . $indice, 'data-id-input' => 'tab' . $indice, 'data-id' => $articulo['id'], 'data-pv-id' => $descuento_id, 'onkeypress'=>'return soloNumeros(event)','target' => '_blank', 'autocomplete' => 'off', 'style' => 'padding: 1px 1px; width:35px;']);
}
	...
	<table class='tablasearch' cellpadding="0" cellspacing="0">	
		...
		<tr>
			...
			<?php
						...
						if ($articulo['carritos'] != null) {
							$cantidadencarrito = $articulo['carritos'][0]['cantidad'];
							echo $this->Form->input($encabezado . 'cantidad', ['tabindex' => $indice, 'value' => $cantidadencarrito, 'class' => 'formcartcant', 'id' => 'tab' . $indice, 'data-id-input' => 'tab' . $indice, 'data-id' =>	$articulo['id'], 'data-pv-id' => $descuento_id, 'target' => '_blank', 'onkeypress'=>'return soloNumeros(event)','autocomplete' => 'off', 'style' => 'padding: 1px 1px; width:35px;']);
						} else {
						
							echo $this->Form->input($encabezado . 'cantidad', ['tabindex' => $indice, 'class' => 'formcartcant', 'id' => 'tab' . $indice, 'data-id-input' => 'tab' . $indice, 'data-id' =>	$articulo['id'], 'data-pv-id' => $descuento_id, 'target' => '_blank', 'onkeypress'=>'return soloNumeros(event)','autocomplete' => 'off', 'style' => 'padding: 1px 1px; width:35px;']);
						}
...
//imgcorazon ='<img src="https://www.drogueriasur.com.ar/ds/webroot/img/CORAZON-CELESTE.png" width="50">';

if(dataimg== 1){

//document.getElementById('flotante').innerHTML="<div id='flotante_text'>"+text+ivaimg+trazaimg+cadenaimg+psiimg+valeoficialimg+fvimg+fvcerca+"</div><div id='flotante_img'>"+imgcorazon+"</div><div id='flotante_img'>"+eanimg+"</div>";
}else{
