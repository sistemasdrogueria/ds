<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $ctacteTarjetasCredito->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $ctacteTarjetasCredito->id)]
            )
        ?></li>
...
<div class="ctacteTarjetasCreditos form large-10 medium-9 columns">
    ...
    <fieldset>
        <legend><?= __('Edit Ctacte Tarjetas Credito') ?></legend>
        <?php
