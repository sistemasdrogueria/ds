...
<article class="module width_full">
	...
	<tr>			
            ...
            <td><h4><?php echo str_pad($reclamo['factura_seccion'], 4, '0', STR_PAD_LEFT).'-'.str_pad($reclamo['factura_numero'], 8, '0', STR_PAD_LEFT); ?></h4></td>
	</tr>
	<tr>			
            <td><h4 ><?= __('Pedido Nro') ?></h4></td>
            <td><h4><?php echo $reclamo->pedido_numero ?></h4></td>
	</tr>
