...
<div class = "gallery-cell-cm"    style="text-align: center; margin:0px auto; background-color:#f4f4f4 ">
...
<!-- div class="product-thumb-cm">  
<?php //echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'Carritos','action'=>'search_i',' ',$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);?> 

</div -->
<div class="product-cm-logo"> 

<?php 
echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'Carritos','action'=>'search_hss',$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);
						
//echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'Carritos','action'=>'search_bf',$oferta['marca_id'],$oferta['laboratorio_id']]]);?> 
</div>
<!-- div class ="product-cm-logocm-izq" >
<?php // echo $this->Html->image('icon_scw_izq2.png',['url'=>['controller'=>'Carritos','action'=>'search_bf',$oferta['marca_id'],$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);?> 
</div>
<div class ="product-cm-logocm-der" >
<?php // echo $this->Html->image('icon_scw_der2.png',['url'=>['controller'=>'Carritos','action'=>'search_bf',$oferta['marca_id'],$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);?> 
</div -->
</div>
</div>
<?php } 
...
<?php 
			switch ($oferta['oferta_tipo_id']) {
				case 2:
					echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'Carritos','action'=>'promocion',$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);

					break;
				case 4:
					if ($oferta['busqueda_sect']!= "EXPO")
					echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'Carritos','action'=>'search_i',$oferta['busqueda_sect'],$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);
					else
