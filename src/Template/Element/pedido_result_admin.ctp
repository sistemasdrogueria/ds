...
<div>
    <div id="tab1" class="tab_content">
            ...
            <tbody>
                <?php foreach ($pedidos as $pedido): ?>
                    ...
                    if ($pedido['estado_id'] == 1) {
                        ...
                        switch ($pedido['tipo_fact']) {
                            ...
                            case 'N':
                                ...
                                else $colorfondo = '#ffbbff';
                                break;
                            case 'TR':
                                if ($esisla == 1)    $colorfondo = '#bbffaa';
                                else $colorfondo = '#bbffff';
                                break;
                            case 'TL':
                                if ($esisla == 1)    $colorfondo = '#ccffaa';
                                else $colorfondo = '#ccffff';
                                break;
                            default:
                                $colorfondo = '#FFFFFF';
                                break;
                    ...
                    <td class=colcenter><?php
                                        if ($pedido['comentario'] != null) {
                                            if (!empty($pedido['comentario'])) {
                                                $cadenaComen = preg_replace('/\d+/', '', $pedido['comentario']);
                                            } else {
                                                $cadenaComen = $pedido['comentario'];
                                            }
                                            switch ($cadenaComen) {
                                                case 'TRANSFER':
                                                    echo 'TRANSFER L';
                    ...
                    <td class="actions">
                        ...
                        echo $this->Html->link(
                            $this->Html->image("admin/admin_view.png", [
                                "alt" => "ver",
                                'escape' => false,
                                'target' => '_blank',
        ...
        'data-static'=>'img/admin/admin_view.png','data-hover'=>'img/admin/admin_view_i.gif',*/
                            ...
                            ['controller' => 'pedidos', 'action' => 'view_admin',  $pedido['id']],
                        ...
                        switch ($pedido['pedidos_status_id']) {
                            case 3:
                                ...
                                echo $this->Html->link(
                                    $this->Html->image("admin/admin_pos_duplicado.png", [
                                        "alt" => "DUPLICADO",
                                        'escape' => false,
                                        'target' => '_blank',
                                    ...
                                    ['controller' => 'pedidos', 'action' => 'duplicate_admin',  $pedido['tipo_fact'], $pedido['cliente_id']],
                                    ['escape' => false, 'target' => '_blank']
                                );
                        ...
                        if ($pedido['forma_envio'] == 99)
                            echo $this->Html->image("admin/admin_retiro.png", [
                                "alt" => "Retira Cadete",
                                'data-static' => '../img/admin/admin_retiro.png',
                                'data-hover' => '../img/admin/admin_retiro.gif',
                                'class' => 'hover-gif',
                                'style' => 'width=50px'
                            ]);
                        ...
                        if (($pedido['c']['codigo'] > 79000 && $pedido['c']['codigo'] < 79999)) {
                            echo $this->Html->image("admin/admin_avion.png", [
                                "alt" => "Tierra del Fuego",
                                'data-static' => '../img/admin/admin_avion.png',
                                'data-hover' => '../img/admin/admin_avion.gif',
                                'class' => 'hover-gif',
                                'style' => 'width=50px'
                            ]);
