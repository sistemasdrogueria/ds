    ...
    <table class='tablasearch' id="formaddcart" cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th colspan="4" align="center"><?= h('Ofertas') ?></th>
                <th rowspan="2">Ref.</th>
                <th rowspan="2"></th>
            </tr>
            <tr>
                <th>
                    <div id="th-sub-tabla">Dto</div>
                    </td>
                <th>
                    <div id="th-sub-tabla">U.Min</div>
                    </td>
                <th>
                    <div id="th-sub-tabla">Plazo</div>
                    </td>
                <th>
                    <div id="th-sub-tabla">Tipo Of.</div>
                    </td>
            </tr>
        </thead>
        <tbody class="import">
            ...
            ?>
                <tr id="trimport<?php echo $articulo['id']; ?>">
                    ...
                    <div class=formcartcanttd_div > 
                        <button class="btn btn-sm" onclick="decrementImport(<?php echo $articulo['id']; ?>,<?php echo $descuent ?>,<?php echo $articulo['id']; ?>,<?php echo $articulo['carritos_temps'][0]['id'] ?>);" return="false;">-</button>
                        <?php
                        echo $this->Form->input($encabezado . 'cantidad', ['tabindex' => $indice, 'value' => $cantidad_unidades, 'class' => 'formcartcante', 'data-valor' => 'ca' . $articulo['id'], 'data-id' => $articulo['id'], 'data-pv-id' => $descuent, 'autocomplete' => 'off']);
                    
                        ?>
                        <button class="btn btn-sm" onclick="incrementImport(<?php echo $articulo['id']; ?>,<?php echo $descuent ?>,<?php echo $articulo['id']; ?>);">+</button>
                        </div>
                    </td>
...
if (count($articulo['descuentos']) > 1)
                    ...
                    <td class="actions">
                        <a href="#" onclick="preguntarSiNoMenosImport(<?php echo $articulo['carritos_temps'][0]['id'] ?>,<?php echo $articulo['id']; ?>)"><img src="/ds3/img/delete_ico.png" alt=""></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
