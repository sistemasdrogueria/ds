...
<li class='active has-sub'>
<?=$this->Html->link(__('Perfumeria'),['controller'=>'Novedades','action'=>'perfumeria'])?>
<ul>
...
<li class='active has-sub'>
<?=$this->Html->link(__('Catalogos'),['controller'=>'Catalogos','action'=>'especial2'])?>
<ul>
...
<li><?=$this->Html->link(__('Rev. Noviembre'),['controller'=>'Catalogos','action'=>'revista'])?></li>
</ul>
</li>
<?php if ($this->request->session()->read('Auth.User.farmapoint')>0) ?>
<li><?= $this->Html->link(__('Farma Point'), ['controller' => 'Carritos', 'action' => 'farmapoint']) ?></li>
