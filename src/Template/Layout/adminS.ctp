...
<article class=breadcrumbs><?php echo $this->Html->link(__('Pedidos'), ['controller' => 'Pedidos', 'action' => 'index_admin_new']); 
if ($this->request->session()->read('Auth.User.role')=='admin') 
echo '<div class=breadcrumb_divider></div>'. $this->Html->link(__('Menu Completo'), ['controller' => 'Users', 'action' => 'index']) 
