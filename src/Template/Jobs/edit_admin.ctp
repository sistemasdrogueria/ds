...
<?= $this->Form->create($job, ['url'=>['controller'=>'Jobs','action'=>'edit_admin']]) ?>
...
<fieldset>		
<?= $this->Form->input('fecha', ['label'=>'fecha:','id'=>'fechadesde','value'=>date_format($job['fecha'],'d/m/Y'),'name'=>'fecha', 'type'=>'text','placeholder'=>'Fecha']);?>
</fieldset>
<fieldset>
