<div class="col-md-9">
<?php echo $this->element('banner_slider_ajaxi'); ?>
<div class="product-thumb" id="search-backf">
<?php echo $this->element('carrito_searchajax'); ?>
</div>
...
var jssor_slideri = new $JssorSlider$("slideri_container", options);

function ScaleSliderZocaloi() {
var bodyWidth = document.body.clientWidth;
jssor_slideri.$scale
jssor_slideri.$ScaleWidth($("#slider_contenedori").width());
}
ScaleSliderZocaloi();
$(window).bind("load", ScaleSliderZocaloi);
$(window).bind("resize", ScaleSliderZocaloi);
$(window).bind("orientationchange", ScaleSliderZocaloi);
