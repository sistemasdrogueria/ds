...
<h4><?php echo 'Patagonia Med';?></h4>
<div class="row">	
<div class="menu-ofertas">
<div class="list-menu">			
<div id='cssmenu'>
<ul>	
<?php $archivoptm= 'https://www.drogueriasur.com.ar/ds/webroot/descargas/'. $consolidadoptm['name']; 
$tituloptm = 'Consolidado '.$consolidadoptm['descripcion'];
?>
<?php 
if (!empty($consolidadodermo)) {
$archivoder= 'https://www.drogueriasur.com.ar/ds/webroot/descargas/'. $consolidadodermo['name'];
$tituloder = 'Consolidado Dermocosmetica '.$consolidadodermo['descripcion']; }
?>
...
var cuerpo = "<iframe src='https://docs.google.com/gview?url="+ archivo.toString()+ "&embedded=true' style='width:600px; height:700px;' frameborder='0'></iframe>";
