...
<?php echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'Carritos','action'=>'promocion',$oferta['busqueda'],$oferta['detalle']]], ['loading'=>'lazy','alt' => str_replace('"', '', $oferta['descripcion'])]);?> 
</div> 
...
echo $this->Html->image('ofertas/'.$oferta['imagen'], ['loading'=>'lazy','alt' => str_replace('"', '', $oferta['descripcion'])]);
//else
