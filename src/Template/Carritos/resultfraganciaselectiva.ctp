...
<?php 
{echo $this->element('searchmarcas'); }
?>
</div> <!-- /.product-content -->
</div> <!-- /.product-item -->
</div> <!-- /.col-md-3 -->
...
{
echo $this->element('searchresultfragancia'); }
else
{
?>		
<div class='cliente_info_class2'>Fragancias Selectivas</div></br>
<?php
echo $this->element('searchsinresultfraganciamarca');
?>	
<div class='cliente_info_class2'>Ultimas Novedades</div></br>
<?php
echo $this->element('searchsinresultfragancia'); 
}
?>
</div> <!-- /.product-content -->
</div> <!-- /.product-item -->
