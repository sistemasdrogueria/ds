	...
	<span class='cliente_info_span'>Estado de Cuenta Corriente</span>
		<table cellpadding="0" cellspacing="0">
			<tr> 
				...
				<td class="carrito_importe_red"><?php  echo '$ '. number_format($totalvencidaX[0],2,',','.');?></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="ctadescripcion">
				<?php echo ' - Nota de Débito';?>
				</td>
				<td class="carrito_importe_red_dark"><?php echo '$ '.  number_format($totalvencidaX[5],2,',','.');?></td>
			</tr>				
			...
			<tr>
				<td class="ctadescripcion">
				<?= $this->Html->link(__(' - Tarjetas de Credito'), ['controller' => 'CtacteEstados', 'action' => 'credito']) ?>
				</td>
			...
			<td class="carrito_importe"><?php echo '$ '.  number_format($totalvencidaX[0]-$totalcredito,2,',','.');?></td>	
