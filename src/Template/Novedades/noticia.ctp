...
echo '<iframe src="http://docs.google.com/gview?url=http://200.117.237.178/ds/webroot/img/novedades/'.$novedade->img_file2.'&embedded=true" style="width:95%; min-height:550px;" frameborder="0"></iframe>';																			
else
