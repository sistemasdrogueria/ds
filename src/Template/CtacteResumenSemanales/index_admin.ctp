...
<script>
			...
			function pad(x,z) {
				...
				var nombre = "RESU"+pad(xy,6)+pad(x,8)+".pdf";
					...
					{
							var text = '<br>Resumen no disponible momentaneamente.<br>';
							$("#titulo_oferta").html(text);
					}	
				}
</script>
<article class="module width_3_quarter">
	...
	<div> 
	<?php  //$this->Form->create('CtacteResumenSemanales',['url'=>['controller'=>'CtacteResumenSemanales','action'=>'view_admin'],'id'=>'searchform4']); ?>
		...
		<div class="input_date_search">
			<div class="input_date_input_search">
				...
				echo $this->Form->input('nro_sistema', ['id'=>'selectsemananro','label'=>'','options' => $ctacteResumenSemanales, 'onchange'=>'selectsemana(this);']);?>		
			</div>
		</div>
		<div>
			<?php  //$this->Form->submit('Buscar',['class'=>'submit_link','id'=>'button_search']); ?>
		</div>
