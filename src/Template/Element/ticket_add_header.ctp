...
<fieldset>
	...
	echo $this->Form->input('fecha_recepcion', ['label'=>'Fecha Pedido','id'=>'fecha_recepcion', 'type'=>'text','placeholder'=>'Fecha Pedido','disabled' => 'disabled','value'=>$reclamo['fecha_recepcion']]);
...
if ((facturanumero.length>5) && (reclamostipoid.length>1)))
{ 
alert(0);
return true;
}
