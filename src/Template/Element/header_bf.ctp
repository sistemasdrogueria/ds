...
<div class=logods>
<?php echo $this->Html->image('logo_ds2024_bf.png',['alt'=>'Drogueria Sur S.A.','id'=>'logo_web','url'=>['controller'=>'Carritos','action'=>'index']]);?>
</div>
</div>
<div class="col-md-4 col-sm-3 col-xs-3">
...
<li style='float: right;  height:40px; margin:0 5px 0 5px;'> <?php echo $this->Html->image('icon_salir_bf.png', ['url'=>['controller' => 'Users', 'action' => 'logout']],['alt' => 'Cerrar Sesión','class'=>'codrops-icon codrops-icon-back']);?></li>
<li style='float: right;  height:40px; margin:0 5px 0 5px;'> <?php echo $this->Html->image('icon_configurar_bf.png', ['url'=>['controller'=>'Clientes','action'=>'view']],['alt' => 'Ver Evento']);?></li>
<li style="float: right;  height:40px; margin:0 5px 0 5px;"> <?php echo $this->Html->image('icon_comunidad_bf.png', ['url'=>['controller' => 'ComunidadSur', 'action' => 'index']], ['alt' => 'Comunidad Sur']);?></li>
<?php if ($this->request->session()->read('Auth.User.farmapoint')==1) 
echo '<li style="float: right;  height:40px; margin:0 5px 0 5px;">'.$this->Html->image('logo_tfp_bf.png', ['url'=>['controller' => 'Carritos', 'action' => 'farmapoint']]).'</li>';?>
<li style='float: right; width: 40px; margin:0 5px 0 10px;'> <?php echo $this->Html->image('icon_carro_bf.png', ['alt' => 'Ver carro','id'=>'opener']);?></li>
