...
<?= $this->Form->create('Carritos',['url'=>['controller'=>'Articulos','action'=>'nuevos'],'id'=>'searchform5','class'=>'carrito_search_form2','onsubmit'=>'return validar()']); ?>
<?php
$ofertastipo= [1=>'Perfumería y Acces.', 2=>'Patagonia Med', 3=>'Todas las Ofertas'];
echo $this->Form->input('terminobuscar', ['label'=>'','id'=>'terminobuscar','name'=>'terminobuscar','value'=>'', 'type'=>'text','placeholder'=>'Buscar Producto', 'onchange'=>'javascript:document.confirmInput.submit();','style'=>'width: 40%;min-width: 180px;']);
