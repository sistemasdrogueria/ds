...
var myBaseUrlsbuscar = '<?php echo \Cake\Routing\Router::url(array('controller' => 'Carritos', 'action' => 'buscar')); ?>';
...
<?php echo $this->fetch('meta');echo $this->Html->meta('favicon.ico','/favicon.ico',['type'=>'icon']);echo $this->Html->css('jquery-ui.min');echo $this->Html->script('jquery-1.11.3.min');echo $this->Html->script('bootstrap');echo $this->Html->script('jquery-ui-1.10.4.custom.min');echo $this->Html->css('bootstrap');echo $this->Html->css('normalize.min');echo $this->Html->css('font-awesome.min');/*echo $this->Html->css('animate.min');*/echo $this->Html->css('templatemo-misc.min');echo $this->Html->css('templatemo-style-cm.min');echo $this->Html->css('stylebar-cm.min');echo $this->Html->script('modernizr-2.6.2.min');echo $this->Html->script('jquery.quick.pagination.min');	echo $this->Html->css('alertify/alertify');?>
...
<div  class=container>
<div class=row>
<?php echo $this->element('header-cm'); ?>
</div>
</div>
</div>
<div class=main-nav>
...
<?php echo $this->Html->script('jquery.easing.1.3.min');echo $this->Html->script('jquery-scrolltofixed.min');echo $this->Html->css('jquery.notifyBar.min');echo $this->Html->script('jquery.notifyBar.min');/*echo $this->Html->script('plugins.min');*/echo $this->Html->script('main.min');echo $this->Html->script('scriptbar.min'); echo $this->Html->script('alertify/alertify');echo $this->Html->script('modal');?>
