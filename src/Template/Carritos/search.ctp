...
<?php echo $this->element('search_ajax'); ?>
</div>
<div class="product-item-3" id="resultarticulos">
...
<div class="col-md-3" id="resultacarritos">
...
<div class="product-item-5">		
<div class="product-content">
<div class='cliente_info_class3'><?php echo $this->Html->image('icon_carro_view.png'); ?></div>
...
function agregarcantidadbarras(){
$("#tab1").attr("val", 1);
...
<?php if(isset($agregarcantidadbarras)){
if($agregarcantidadbarras==1){
echo '<script>agregarcantidadbarras();</script>';
}
}
