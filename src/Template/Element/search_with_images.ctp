...
<?= $this->Form->create('Carritos',['url'=>['controller'=>'Carritos','action'=>'search_i'],'id'=>'searchform5','class'=>'carrito_search_form','style'=>'text-transform:capitalize;','onsubmit'=>'return validar()']); ?>
<?php // $this->Form->create('',['url'=>'','id'=>'searchform6','class'=>'carrito_search_form','onsubmit'=>'return validar()']); ?>
<?php
$ofertastipo= [1=>'Perfumería y Acces.', 2=>'Patagonia Med',4=>' Off. Vencimiento Cercano', 3=>'Todas las Ofertas'];
...
var nombre=$('#terminobuscar').val().replace(/[^a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ\s\'\_\"\.\-]/g, '');
