...
//echo '<div>'.$this->Html->image('publicaciones/'.$slider['imagen'],['url'=>$slider["url_campo"],'data-u'=>'image'],['target' => '_blank','_full' => true,'escape' => false]).'</div>';
endforeach; ?>
</div>
<style>
...
.contadorbf li span {  display: block; font-size: 3.5rem;}
...
<?php echo $this->Html->image('logo_exposur_7_l.png',['alt'=>'EXPOSUR VIRTUAL ESTA LLEGANDO.','url'=>'https://exposurvirtual.com.ar']);?>
</div>
<div class=contadorbf align=center style="width:70%; float: right">
<ul>
...
<script>
var futuro = new Date(2021, 03, 18, 23, 59).getTime();
