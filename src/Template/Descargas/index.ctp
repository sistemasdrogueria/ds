<div class="col-md-7">
    <div class="product-item-3"> 
		<div class="product-content3">
			...
			<p>Para descargar el archivo de producto <a href="https://200.117.237.178:8080/down/arch/articulos.zip"><b>haga click aqu&iacute;</b></a></p>
			<TABLE WIDTH="100%" >
                <TR> 
                    ...
                    <TD align="left" valign="top" class="texto">
                        ...
                        &nbsp;&nbsp; &nbsp;
                        <?php
						$filename = 'http://200.117.237.178:8080/down/arch/articulos.zip';
		...
		<div class="row">
			...
			<p><a href="http://200.117.237.178:8080/down/arch/aumentos.txt"><b>Haga clic aquí</b></a> con el botón derecho del mouse y elija la opción "Guardar enlace como" para bajar un archivo únicamente con las actualizaciones de precio.</p>
			<TABLE WIDTH="100%" >
                <TR> 
                    <TD WIDTH="250px" align="left" valign="top" ><div id="descripcion-campo"><B>FECHA Y HORA DEL ARCHIVO</B></div></TD>
                    <TD align="left" valign="top"class="texto" >
                        ...
                        &nbsp; &nbsp;&nbsp; 
						<?php
						$filename = 'http://200.117.237.178:8080/down/arch/aumentos.txt';
							if (file_exists($filename)) {
								echo ''.date("d/m/Y H:i:s.", filemtime($filename));
							}
						?>  
    ...
    <p><a href="http://200.117.237.178:8080/down/arch/descuentosptm.txt"><b>Haga clic aquí</b></a> con el botón derecho del mouse para descargar el archivo de descuentos de Patagonia Med.</p>
        <TABLE WIDTH="100%" >
                          <TR> 
                            <TD WIDTH="250px" align="left" valign="top" ><div id="descripcion-campo"><B>FECHA Y HORA DEL ARCHIVO</B></div></TD>
                            <TD align="left" valign="top" class="texto">  <!--#config timefmt="%e del %m de %Y - %T" -->
                              &nbsp;&nbsp;&nbsp;
							   <?php
							$filename = 'http://200.117.237.178:8080/down/arch/descuentosptm.txt';
							if (file_exists($filename)) {
								echo ''.date("d/m/Y H:i:s.", filemtime($filename));
							}
							?>  
