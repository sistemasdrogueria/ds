...
class OfertasController extends AppController
{
    ...
    {
	if (in_array($this->request->action, ['index_admin','otros_admin','add','edit_oferta','edit_admin','delete_admin','view_admin','index_admin_search','add_admin_search','add_admin_oferta','add_admin_perfumeria','perfumeria','deshabilitar_admin','cambiarfechas_admin'])) {
	...
	public function edit_oferta()
    {
		...
		$listaofertas = $entities;
		
		$this->set('listaofertas', $listaofertas);
		foreach ($listaofertas as $oferta) {
		
				$oferta['activo']= $oferta['habilitada'];
