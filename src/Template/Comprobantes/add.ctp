<div class="actions columns large-2 medium-3">
    ...
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('List Comprobantes Tipos'), ['controller' => 'ComprobantesTipos', 'action' => 'index']) ?></li>
        <li><?= $this->Html->link(__('New Comprobantes Tipo'), ['controller' => 'ComprobantesTipos', 'action' => 'add']) ?></li>
    </ul>
</div>
<div class="comprobantes form large-10 medium-9 columns">
    ...
    <fieldset>
        ...
        <?php
            ...
            echo $this->Form->input('comprobante_tipo_id', ['options' => $comprobantesTipos, 'empty' => true]);
        ?>
    </fieldset>
