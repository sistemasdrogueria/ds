...
echo $this->Html->link($this->Html->image("admin/icn_view.png", ["alt" => "Ver"]),['controller' => 'pedidos', 'action' => 'view_admin_new',  $pedido['id']],['escape' => false,'target'=>'_blank']);
