...
echo $this->Html->css('templatemo-style.min.css?'.$filever2= filesize('css/templatemo-style.min.css'));echo $this->Html->css('stylebar.min');echo $this->Html->script('modernizr-2.6.2.min');echo $this->Html->script('jquery.quick.pagination.min');	echo $this->Html->css('alertify/alertify');echo $this->Html->script('alertify/alertify');echo $this->Html->script('functionsadd.js?'.$filever= filesize('js/functionsadd.js'));  echo $this->Html->script('marquee3k.js'); ?>
