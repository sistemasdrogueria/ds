...
<?php //echo $this->Html->image('hotsale.png',['alt'=>'Drogueria Sur S.A.','url'=>['controller'=>'Carritos','action'=>'hotsale']]);?>
...
echo '<li>'.$this->Html->image('comunidadsur.png', ['alt' => 'Comunidad Sur','url'=>'http://www.drogueriasur.com.ar/cs']).'</li>';?>
...
<!--li><?=$this->Html->link(__('Exhibidores'),['controller'=>'Novedades','action'=>'exhibidores'])?></li -->
...
<ul>
<!-- li><?=$this->Html->link(__('Día del Niño'),['controller'=>'Catalogos','action'=>'especial'])?></li -->
<!-- li><?=$this->Html->link(__('Fiestas 2019-20'),['controller'=>'Catalogos','action'=>'especial'])?></li -->
<!-- li><?=$this->Html->link(__('Día de la Madre'),['controller'=>'Catalogos','action'=>'especial'])?></li -->
<li><?=$this->Html->link(__('Revista'),['controller'=>'Catalogos','action'=>'revista'])?></li>
<!--li><?=$this->Html->link(__('Solares 19/20'), ['controller' => 'Catalogos', 'action' => 'especial2']) ?></li -->
</ul>
</li>
