...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <tr>
      ...
      <td colspan="2"  align="center" height="50" valign="middle">
				<span style="font-size: 22px; color: #005ca4; font-weight: bold">SOLICITUD DE TARJETA</span>
				<br>
      </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
        ...
        <td colspan="2">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="3" class="fila" align="left" height="20" valign="middle"> TARJETA: 
              <strong align="center" class="transaccion"><?php if ($opcion==1) echo 'Banco Credicoop'; 
                if ($opcion ==2) echo 'Banco Nación'; ?></strong></td>
            </tr>	
         </tbody>
        </table>
       </td>
