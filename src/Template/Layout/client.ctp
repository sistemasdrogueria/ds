...
<div class="wrapper row2">
  ...
  <div id="intro" class="clear">
	...
	<?php echo $this->Html->image('client/cv-portada.jpg', ['alt' => 'Drogueria Sur S.A.','url'=>['controller'=>'Pages','action'=>'index']]);?>
	</div>
	<div style="padding:30px; float: left; margin-left: 100px; margin-top: -230px; z-index: 3; background-color:#FFFFFF;">
		<?php echo $this->Html->image('client/logo200.png', ['alt' => 'Drogueria Sur S.A.','style'=> "width: auto;max-width: 300px;",'url'=>['controller'=>'Pages','action'=>'index']]);?>
	</div>
	<div>
      <p class="nospace" style="float: right;  margin-right: 180px; margin-top: -90px; z-index: 4;">
	 <?php  echo $this->Html->link(	'Volver',	['controller' => 'Pages', 'action' => 'index', '_full' => true],
...
<div class="wrapper row3">
  <div id="container">
    ...
    <div id="homepage" class="clear">
      ...
      <div class="one_third">
        <div class="clear">
			<h2 class="font-medium">INFORMACIÓN DE CONTACTO</h2>
