	...
	<fieldset>
		<div class="">
			...
			if ($articulo->fv_cerca) {
				echo
				$this->Form->input('fv_cerca', ['label' => 'Vencimiento cerca', 'type' => 'checkbox', 'value' => $articulo->fv_cerca, 'checked' => true]);
			} else {
				echo
				$this->Form->input('fv_cerca', ['label' => 'Vencimiento cerca', 'type' => 'checkbox', 'value' => $articulo->fv_cerca, 'checked' => false]);
			}
			?>
		</div>
		<div class="">
