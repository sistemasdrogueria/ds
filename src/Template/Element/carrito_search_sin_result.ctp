...
<?php 
echo $this->Html->image('ofertas/'.$oferta['imagen'],['url'=>['controller'=>'CarritosTransfers','action'=>'search',$oferta['laboratorio_id']]], ['alt' => str_replace('"', '', $oferta['descripcion'])]);
...
if ($oferta['aplicaen']==6)
echo '<div class="oferta_descuento offparpadea" style=" margin-top: 5px; font-size: 35px;">6x5</div>';
...
if ($descuento['dto_drogueria']!=null && $oferta['aplicaen']==6)
echo '<div class="oferta_enlaxunidad">en la 6ra unidad</div>';
...
if ($oferta['aplicaen']==5)
echo $off.'% en la 5ra unidad';
if ($oferta['aplicaen']==6)
echo $off.'% en la 6ra unidad';
if ($oferta['aplicaen']==10)
