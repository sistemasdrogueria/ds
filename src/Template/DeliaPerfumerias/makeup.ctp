...
<?php
echo '<div class=row>'.$this->element('delia_makeup_search').'</div>';
echo '<div class=row><br>'. $this->element('delia_makeup_marcas');
echo $this->element('delia_makeup_sin_result'); 
echo '</div>';
?>
</div> <!-- /.product-content -->
</div> <!-- /.product-item -->
