...
<?= $this->Form->create('DeliaPerfumerias',['url'=>['controller'=>'DeliaPerfumerias','action'=>'resultmakeup'],'id'=>'searchform']); ?>
<?php
...
echo $this->Form->end();
echo '<div class=search-form-input>'. $this->Html->image('icn_volver.png', ['url'=>['controller'=>'DeliaPerfumerias','action'=>'makeup'],'alt' => 'volver']).'</div>';
