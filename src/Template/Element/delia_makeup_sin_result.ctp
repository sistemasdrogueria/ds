...
<div id=slider_container_makeup style="width:100%">
...
foreach ($incorporations as $incorporation): 
		...
		echo '<div>'.$this->Html->image('incorporations/makeup/'.$incorporation['imagen'],['data-u'=>'image']).'</div>';
endforeach; ?>
</div>
...
function ScaleSlider() {
var slider_container_makeup = document.getElementById('slider_container_makeup');
var bodyWidth = slider_container_makeup.clientWidth;
