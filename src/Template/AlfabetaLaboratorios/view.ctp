...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Alfabeta Laboratorio'), ['action' => 'edit', $alfabetaLaboratorio->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Alfabeta Laboratorio'), ['action' => 'delete', $alfabetaLaboratorio->id], ['confirm' => __('Are you sure you want to delete # {0}?', $alfabetaLaboratorio->id)]) ?> </li>
...
<div class="alfabetaLaboratorios view large-9 medium-8 columns content">
    <h3><?= h($alfabetaLaboratorio->id) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            ...
            <td><?= $alfabetaLaboratorio->eliminado ? __('Yes') : __('No'); ?></td>
        </tr>
    </table>
    <div class="related">
        <h4><?= __('Related Alfabeta Articulos') ?></h4>
        <?php if (!empty($alfabetaLaboratorio->alfabeta_articulos)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($alfabetaLaboratorio->alfabeta_articulos as $alfabetaArticulos): ?>
            <tr>
