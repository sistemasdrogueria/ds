...
<div style="float: right;display: block;margin-left: 1px;"> ¿Todavía no sos cliente? <br>Hacé <?= $this->Html->link(__("click acá"), ['controller' => 'ClientesAltas', 'action' => 'add']) ?> para serlo.</div>
</div>
<div class="col-md-12">
<div class="col-md-12">
