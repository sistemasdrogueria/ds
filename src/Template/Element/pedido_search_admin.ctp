...
<div class="input_date_input_search">
    <?php $opciones = Array();
        $opciones = ['1'=>'RETIRA','2'=>'RETIRA FTP','3'=>'PEDIDO N', '4'=>'PEDIDO TR/TL', '5'=>'P.PAMI','6'=>'RECIBIDO', '7'=>'A FACTURAR','8'=>'TDF' ]
    ?>
<?= $this->Form->input('termino4', ['label'=>'','options'=>$opciones,'class'=>'input_date_input_search_i','placeholder'=>'','empty'=>'opciones' ]); ?>
