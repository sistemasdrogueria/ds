...
.input_date_input_search_i {    width: 130px;padding: 10px !important;}
...
<div class="input_date_search">
<div class="input_date_input_search">
<?php echo $this->Form->input('tipo', ['class'=>'input_date_input_search_i','label'=>'','onchange'=>'this.form.submit();','options' => $incorporationstipos2,'empty'=>'Tipo de Incorporaciones']);?>
</div>
</div>
