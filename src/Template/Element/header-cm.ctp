...
.temps{position:absolute;top:60%;left:50%;transform:translate(-50%,-50%);color:#000;font-weight:700;font-size:11px}
.temps60{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);color:#000;font-weight:700;font-size:11px}
...
<!-- li style='float: right; width: 40px; margin:0;'> <?php echo $this->Html->image('icono_carro_transfers.png', ['alt' => 'Ver carro','id'=>'opener_transfer']);?></li -->
<?php //if($this->request->session()->read('totalunidades_transfer')<99){echo "<div class='carro_unidades_ico_transfer'   id='openert_transfer'><div>";echo "<div class='carro_unidades_nro_transfer' id='openerts_tranfers'  data-value=".$this->request->session()->read('totalunidades_transfer')." value=".$this->request->session()->read('totalunidades_transfer').">".$this->request->session()->read('totalunidades_transfer')."</div>";}?>
<?php //if($this->request->session()->read('totalunidades_transfer')>=99){echo "<div class='carro_unidades_ico_transfer'  id='openert_transfer'><div>";echo "<div class='carro_unidades_nro_transfer'  id='openerts_tranfers' data-value=".$this->request->session()->read('totalunidades_transfer')." value=".$this->request->session()->read('totalunidades_transfer').">+99</div>";}
?>
</ul>
</div>
</div>
