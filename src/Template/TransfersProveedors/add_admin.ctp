...
.input_file_tfl_file label{
	margin: 0 10px 0 10px;
	width: 150px;
	padding-top:5px;
}
.input_file_tfl_file input[type=file]{
	width: 200px;
	height:30px;
}
.input_file_tfl_option label{
	margin: 0 10px 0 10px;
	width: 100px;
	float: left;
	padding-top: 5px;
}
.input_file_tfl_option{
	float: left;

}
.input_file_tfl_option select {
	width: 200px;
	padding: 5px;
	height:30px;
	
}
.input_file_tfl_option input[type=select]{
	width: 200px;
}
</style>
...
<fieldset>
	...
	<?php		echo $this->Form->submit('Procesar',['class'=>'mainBtn']);
			echo $this->Form->end() 
	?>
