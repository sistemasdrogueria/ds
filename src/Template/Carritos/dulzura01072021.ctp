...
<?php //echo $this->element('expo_search_head'); 
echo $this->element('banner_laboratorio'); ?>
...
<?php if (!empty($articulos)){echo $this->element('carrito_dulzura_result'); }?>
<?php //echo $this->element('expo_search_referencia'); ?> 
