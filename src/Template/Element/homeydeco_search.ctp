...
<?php 
if (!empty($gruposf2))
echo '<div style="margin-top: 10px;">'.$this->Form->input('grupo_id_2', ['label'=>'','options' => $gruposf2,'empty'=>'Subcategorias','style'=>'color: #000000;	border: 1px solid #909090; width: 200px; ','class'=>'grupo-id2', 'onChange'=>'document.getElementById("searchform").submit();']).'</div>'; 
else
...
<div style="margin-left: 20px;"><h1 style="text-align: center; color: #7abcc8;  margin-top: 10px;  font-size: 3.0em;">  
