...
.one_nutricion a {/*font: 13px/21px "Open Sans", Arial, sans-serif;*/
  font-family: 'Poppins', Arial, sans-serif;
  font-size: 22px;
  line-height: 25px;
  font-weight: bold;height: 150px;width: 100%;color: #154c72;display: flex;align-items: center;justify-content: center;border: 5px solid #bcd266;border-radius: 5px;text-align: center;}
