...
<?php
echo $this->Form->input($encabezado.'cantidad',['tabindex'=>$indice,'value' =>$cantidad_unidades ,'class'=>'formcartcant','onchange'=>'javascript:document.confirmInput.submit();','autocomplete'=>'off']);
