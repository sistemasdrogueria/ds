...
'name'=>'factura_numero','label'=>'Número Factura','pattern'=>'[0-9]{4}[-]{1}[0-9]{8}','required'=>true ,'disabled' => 'disabled','value'=>str_pad($reclamo['factura_seccion'], 4, '0', STR_PAD_LEFT).'-'.str_pad($reclamo['factura_numero'], 8, '0', STR_PAD_LEFT)]);
