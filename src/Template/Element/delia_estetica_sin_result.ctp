...
.col-item {padding: 0;border: 5px solid #fff;background: 0 0;margin-bottom: 50px;}.col-item .photo {position: relative;	max-width : 150px;}
...
.row { margin-top : 15px; align-items: center; margin-left : 0px; margin-right : 0px;}
.contenido3 { margin: 0 auto; /* requerido para alineación horizontal */}
.container { padding-right: 0px; padding-left: 0px;}
</style>
<div id=slider_container_dermo style="width:100%">
<div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto; top: 0px; left: 0px; width: 1300px; height: 470px; overflow: hidden;">
<!-- Slides Container -->
<div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 1300px; height: 470px; overflow: hidden;">
<?php
foreach ($incorporations as $incorporation): 
		if ($incorporation['incorporations_tipos_id']==14) 
		echo '<div>'.$this->Html->image('incorporations/estetica/'.$incorporation['imagen'],['data-u'=>'image']).'</div>';
endforeach; ?>
</div>
...
function ScaleSlider() {
var slider_container_dermo = document.getElementById('slider_container_dermo');
var bodyWidth = slider_container_dermo.clientWidth;
var content =  bodyWidth;
