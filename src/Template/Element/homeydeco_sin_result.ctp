...
.jssorb031 .i .b{fill:#000;fill-opacity:.5;stroke:#fff;stroke-width:1200;stroke-miterlimit:10;stroke-opacity:.3}
...
foreach ($incorporations as $incorporation): 
		if ($incorporation['incorporations_tipos_id']==13) 
		echo '<div>'.$this->Html->image('incorporations/farmaydeco/'.$incorporation['imagen'],['data-u'=>'image']).'</div>';
endforeach; ?>
</div>
