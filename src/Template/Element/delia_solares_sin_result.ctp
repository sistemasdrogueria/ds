...
<div id=slider_container_solares style="width:100%">
...
foreach ($incorporations as $incorporation): 
		...
		echo '<div>'.$this->Html->image('incorporations/solares/'.$incorporation['imagen'],['data-u'=>'image']).'</div>';
endforeach; ?>
</div>
...
function ScaleSlider() {
var slider_container_solares = document.getElementById('slider_container_solares');
var bodyWidth = slider_container_solares.clientWidth;
