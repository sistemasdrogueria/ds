...
.iconoslink{width:41.66666667%}
.iconoclima{width:25%}
p.nomDaySim{transform:translate(-40%,-50%)!important}
}
</style>
...
<li style='float: right; width: 40px; margin:0 5px 0 10px;'> <?php echo $this->Html->image('icono_carro_hss.png', ['alt' => 'Ver carro','id'=>'opener']);?></li>
