...
<div>
<?php
/*if(!is_null($this->request->session()->read('promo3'))) {
    $promo3 = $this->request->session()->read('promo3');
if ($promo3['url_metodo']!='') {
if ($promo3['url_campo']!='')
echo $this->Html->image('publicaciones/'.$promo3['imagen'],['url'=>['controller'=>$promo3['url_controlador'],'action'=>$promo3['url_metodo'],$promo3['url_campo']],'alt'=>'Drogueria Sur S.A.','width'=>'100%']);
else echo $this->Html->image('publicaciones/'.$promo3['imagen'],['url'=>['controller'=>$promo3['url_controlador'],'action'=>$promo3['url_metodo']],'alt'=>'Drogueria Sur S.A.','width'=>'100%']);
}
else echo $this->Html->image('publicaciones/'.$promo3['imagen'],['width'=>'100%']);
}
if(!is_null($this->request->session()->read('promo4'))) {
    $promo4 = $this->request->session()->read('promo4');
if ($promo4['url_metodo']!='')
{

if ($promo4['url_campo']!='') echo $this->Html->image('publicaciones/'.$promo4['imagen'],['url'=>['controller'=>$promo4['url_controlador'],'action'=>$promo4['url_metodo'],$promo4['url_campo']],'alt'=>'Drogueria Sur S.A.','width'=>'100%']);
else echo $this->Html->image('publicaciones/'.$promo4['imagen'],['url'=>['controller'=>$promo4['url_controlador'],'action'=>$promo4['url_metodo']],'alt'=>'Drogueria Sur S.A.','width'=>'100%']);
}
else echo $this->Html->image('publicaciones/'.$promo4['imagen'],['width'=>'100%']);  
}
 */?>
</div>
