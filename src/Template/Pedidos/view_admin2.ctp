...
<div class="volveratras"><a href="<?= $previous ?>">Volver atras</a></div>
</header>

<div id="buttonprint"><a class="print-preview">Imprimir</a></div>
<div id="buttonprint"><a class="print-marcar">Marcar como Impreso</a></div>
...
var strC = "Cliente N° "; 
var strR = " - Pedido N° ";
var strCN= <?= $pedido->has('cliente') ? h($pedido['cliente']['codigo']): '' ?>;
var strCR= <?php echo $pedido['id'] ?>;
