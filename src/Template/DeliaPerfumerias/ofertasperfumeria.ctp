<div class="col-md-12">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1025px; height: 700px; overflow: hidden; ">
        ...
        <div u="slides" style="cursor: move; position: relative; left: 0px; top: 0px; width: 1025px; height: 700px;
			...
			<div>
                <div id="sliderh2_container" class="sliderh2" style="position: relative; top: 0px; left: 0px; width: 1025px;height: 600px;">
            ...
            <div>
                <div id="sliderh4_container" class="sliderh4" style="position: relative; top: 0px; left: 0px; width: 1025px;
                    ...
                    <div u="slides" style="cursor: move; position: relative; left: 0px; top: 0px; width: 1025px; height: 600px;
                        overflow: hidden;">
                        <div>
						 <?php //<img u="image" src="../img/cosmetica/img01.jpg" /> ?>
							<a class="captionOrange" href="" >Carro de Compras</a>
						    <?php //echo $this->Html->image('agregarcarro.png', ['alt' => 'Agregar Carro','url'=>['controller'=>'Carritos','action'=>'home'],'style'=>"position: absolute; top: 50px; right: 30px; width: 200px;"]);?>
						</div>
                        <div>
						<?php //<img u="image" src="../img/cosmetica/img02.jpg" />?>
						<a class="captionOrange" href="" >Carro de Compras</a>
						    <?php //echo $this->Html->image('agregarcarro.png', ['alt' => 'Agregar Carro','url'=>['controller'=>'Carritos','action'=>'home'],'style'=>"position: absolute; top: 50px; right: 30px; width: 200px;"]);?>
						</div>
                        <div>
						<?php //<img u="image" src="../img/cosmetica/img03.jpg" /> ?>
						<a class="captionOrange" href="" >Carro de Compras</a>
						    <?php //echo $this->Html->image('agregarcarro.png', ['alt' => 'Agregar Carro','url'=>['controller'=>'Carritos','action'=>'home'],'style'=>"position: absolute; top: 50px; right: 30px; width: 200px;"]);?>
						</div>
                ...
                <div u="thumb">
                    <img src="../img/nested-thumb/cosmetica.jpg" />
                    <div class="title_back"></div>
                    <div class="title">
                        Cosmética
                    </div>
