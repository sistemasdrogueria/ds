...
<div class="estados view large-10 medium-9 columns">
    <h2><?= h($estado->id) ?></h2>
    <div class="row">
        ...
        <div class="large-2 columns dates end">
            <h6 class="subheader"><?= __('Nonmbre') ?></h6>
            <p><?= h($estado->nonmbre) ?></p>
        </div>
    </div>
</div>
