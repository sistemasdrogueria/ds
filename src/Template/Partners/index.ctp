...
justify-content: center;" >
						...
						echo '<div class=row><br>'. $this->element('partner_marcas');
...
<div class="col-md-3">
    <!-- div class="product-item-5"> 
		<div class="product-content">
			<div class="row">
			<?php //echo $this->element('partner_cart_resum'); ?>
			</div> 
		</div> 
	</div --> 
	...
	<!--div class="product-item-5">	
		...
		<div class="row" >   
			<?php //echo $this->element('partner_cart_botton'); ?>
			<div class="cartresul">			
			<?php echo $this->element('partner_cart_result'); ?>
			</div>
		</div> 
		</div> 
	</div --> <!--.product-item-1 -->  
