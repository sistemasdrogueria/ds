...
<td class="carrito_importe"><?php echo date_format($facturasCabecera['fecha'],'d-m-Y');?></td>
</tr>	
<tr>
<td class="ctadescripcion"><?= __('Comprobante T.') ?></td>
<td class="carrito_importe"><?php echo $facturasCabecera['letra'].' ';?></td>
</tr>
<tr>
<td class="ctadescripcion"><?= __('Comprobante N°.') ?></td>
<td class="carrito_importe"><?php echo str_pad($facturasCabecera['comprobante']['seccion'] , 4, "0", STR_PAD_LEFT).'-'.str_pad($facturasCabecera['comprobante']['numero']  	, 8, "0", STR_PAD_LEFT);?></td>
</tr>
<tr>
<td class="ctadescripcion"><?= __('N° Pedido Ds') ?></td>
<td class="carrito_importe">  <?= $this->Number->format($facturasCabecera->pedido_ds) ?></td>
</tr>
<tr class="ctadescripciontotal">
<td class="ctadescripcion"><?= __('Imp Exento') ?></td>
<td class="carrito_importe"><?php echo '$ '.number_format($facturasCabecera['imp_exento'],2,',','.'); ?></td>
</tr>
<tr >	
<td class="ctadescripcion"> <?= __('Imp Gravado') ?></td>
<td class="carrito_importe"><?php echo '$ '.number_format($facturasCabecera['imp_gravado'],2,',','.'); ?></td>	
</tr>
<tr>	
<td class="ctadescripcion"><?= __('Imp Iva') ?></td>
<td class="carrito_importe"><?php echo '$ '.number_format($facturasCabecera['imp_iva'],2,',','.'); ?></td>	
</tr>
<tr>
<td class="ctadescripcion"><?= __('Imp Rg3337') ?></td>
<td class="carrito_importe"> <?php echo '$ '.number_format($facturasCabecera['imp_rg3337'],2,',','.'); ?></td>	
</tr>
<tr>
